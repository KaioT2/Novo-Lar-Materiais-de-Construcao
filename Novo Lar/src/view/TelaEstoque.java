...
public class TelaEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tabelaProd.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaProd.getColumnModel().getColumn(1).setMaxWidth(600);
            tabelaProd.getColumnModel().getColumn(2).setMaxWidth(200);
            tabelaProd.getColumnModel().getColumn(3).setMaxWidth(200);
            tabelaProd.getColumnModel().getColumn(4).setMaxWidth(200);
            tabelaProd.getColumnModel().getColumn(5).setMaxWidth(300);
        }
